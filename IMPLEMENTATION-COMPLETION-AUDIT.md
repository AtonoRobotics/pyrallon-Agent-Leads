...
|---|---|---|---|
| PKT-00 | Local ontology 0.3.0 and 13 hash-pinned local contract families; generated models; fixtures; compatibility declarations; drift, schema, migration, and ledger verifiers | Corrected candidate is internally consistent; governing repository admission is pending PR #2 review/merge | Complete PR #2 review/merge and retain repository-CI evidence bound to the admitted commit |
